...
Coincidentally, the k-NN reveals that IBCF performs better than UBCF in these density ranges, a fact which holds true over all experiments.  The RMSE margin is a significant 0.02.
